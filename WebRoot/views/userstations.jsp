				...
				<div class="row-fluid">
                    ...
                    <div class="portlet box grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-list"></i>已分配的岗位</div>

								<div class="actions">

									<a href="/ucenter/users/choose_stations/${id}" class="btn blue addnew"><i class="icon-pencil"></i> 新增</a>
				...
				$("#batchDel").click(function(e) {
                   var checks = $("input.checkboxes:checked");
					if(checks.size()>0){
						...
						//dosomething
						$.post("/ucenter/users/user_stations/remove",{"id":${id},"ids":ids},function(data){
							if(data.status==0){
								checks.each(function(index, element) {
			...
			//绑定删除按钮
				$("i.icon-trash").each(function(index, element) {
					$(this).click(function(e){
						...
						$.post("/ucenter/users/user_stations/remove",{"id":${id},"ids":id},function(data){
							if(data.status==0){
